...
This is a short experiment to model the lift generated by a NACA 4415 airfoil and the associated uncertainties using the Signaloid Cloud Platform. The image below is the side profile of the NACA 4415 airfoil used to collect the experimental data from [1] and pictured in [2]. 
