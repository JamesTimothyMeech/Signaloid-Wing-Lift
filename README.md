...
Then $\Delta p = p_\mathrm{Lower} - p_\mathrm{Upper} = \frac{1}{2} \rho v^2_\infty$ $(C^\mathrm{Lower} - C^\mathrm{Upper})$ as $p_\infty$ is present in the expression for $p_\mathrm{Lower}$ and $p_\mathrm{Upper}$ and therefore cancels out. Once we have calculated $\Delta p$ the lift is 
